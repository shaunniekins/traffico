import { fetchDriverComplaints } from "@/api/printData";
import Image from "next/image";
import React, { useEffect, useState } from "react";

const PrintReportDriverComplaints = React.forwardRef<HTMLDivElement, {}>(
  (props, ref) => {
            ...
            <tbody>
              {data?.map((item, index) => (
                <tr
                  ...
                  <td className="table-td">{item.total_over_speeding}</td>
                  <td className="table-td">{item.total_over_paying}</td>
                  <td className="table-td">{item.total_over_loading}</td>
                  <td className="table-td">{item.total_other_complaints}</td>
                  <td className="table-td">{item.total_complaints}</td>
                </tr>
              ))}
            </tbody>
          </table>
...
PrintReportDriverComplaints.displayName = "PrintReportDriverComplaints";

export default PrintReportDriverComplaints;
