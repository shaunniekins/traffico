...
const SettingsPassengerComponents = () => {
  ...
  return (
    <div className="flex flex-col  select-none overflow-y-hidden h-full p-3 gap-5 overflow-hidden">
      {loading && <LoadingScreenSection />}
      <div className="flex items-start">
        <h1 className="flex font-semibold text-2xl sm:mx-40 text-sky-700 ">
          Settings
        </h1>
      </div>
      <div className="flex flex-col gap-5 w-full md:w-auto">
        <div className="flex flex-col gap-3 md:grid md:grid-cols-2 items-center pt-7 pb-20 sm:mx-40 lg:gap-x-96 sm:gap-y-6 overflow-y-auto">
...
export default SettingsPassengerComponents;
